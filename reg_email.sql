...
--
-- Host: 127.0.0.1
-- Generation Time: 18-Out-2018 às 00:02
...
(8, 'PS4', 'g@jh', 'fd'),
(9, 'Gta', 'g@jh', 'alo'),
(10, 'Juliano Cristian da Silva', 'juliano@ifro.edu.br', 'Startup, startup, startup, startup, startup, startup, startup, startup, startup, startup, startup, startup, startup, startup, startup, startup, startup, startup, startup, startup, startup, startup, startup, startup.'),
(11, 'Lol', 'alcsilva111@gmail.com', 'kl'),
(12, 'Willyan', 'sdsds@fdfd.com', 'sdds'),
(13, 'Willyan', 'infro@gmail.com', 'infro frosso');
